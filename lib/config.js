const titleConfig = {
  ...
  jirengu: `<h1>2022版前端全新体系课程</h1>`,
  cplusplus: `<h1>2022版C++全新体系课程</h1>`
}
      ...
      [
        {
          title: "Java系统课",
          children: [
            { text: "2022版Java体系课「彰德」", link: "https://xiedaimala.com/courses/9990a941-54a0-4e76-9f53-d09bf01e5136#/common" },
      ...
      [
        {
          title: "前端系统课",
          children: [
            { text: "体系课程-若愚", link: "https://xiedaimala.com/courses/57912a9b-6325-4d5e-a3cf-39fe676b99fa#/common" },
            { text: "体系课程-方方", link: "https://xiedaimala.com/courses/16644d89-6b17-4c2f-ac15-dabb994b7696#/common" },
            { text: "前端精进（后端方向）", link: "https://xiedaimala.com/courses/8757eca2-d1b0-4149-b196-4681670ea275#/common" },
            { text: "前端精进（科班方向）", link: "https://xiedaimala.com/courses/9e45f452-6081-4fb1-a43d-75a96dcc2595#/common" },
            { text: "前端精进（全栈开发）", link: "https://xiedaimala.com/courses/00a96d39-c34f-49f2-aff8-b2ac0cf8e9dd#/common" },
...
const videoConfig = {
  ...
  jirengu: {
    ...
    link: 'https://www.bilibili.com/video/BV1uf4y1k7cp',
    actionType: 'redirect',
...
const learningConfig = {
  yinghekongjian: {
    ...
    promise: '承诺一周且5个任务内退全款，1个月内且初级任务之前可申请退款（扣除已经学习的费用）'
  },
  jirengu: {
    href: {
      course: '/new/mode',
    ...
    promise: '承诺一周且5个任务内退全款，3个月内且任务44前可申请退款（扣除已经学习的费用）'
  },
  cplusplus: {
    href: {
      course: '/C++/mode',
    ...
    promise: '承诺一周且5个任务内退全款，4个月内且高级任务前可申请退款（扣除已经学习的费用）'
  }
}
...
const experienceConfig = {
  ...
  cplusplus: {
    ...
    pictureSrc: 'https://static.xiedaimala.com/xdml/image/6e556a51-b8ff-466f-bda6-7d1847e39f2e/2019-9-10-16-2-11.png',
    pdfLinks: [{
      title: '饥人谷2022版 C++课程大纲.pdf',
      link: 'https://static.xiedaimala.com/%E9%A5%A5%E4%BA%BA%E8%B0%B72021%E7%89%88C%2B%2B%E8%AF%BE%E7%A8%8B%E5%A4%A7%E7%BA%B2.pdf'
    }],
    articleLinks: [{
      title: 'C++学习指南',
      subTitle: '优质原创文章',
